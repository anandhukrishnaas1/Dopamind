...
export function AuthScreen({ onLogin }: AuthScreenProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (mode === 'login' || mode === 'signup') {
      ...
      // Forgot password - show success message then go back
      setMode('login')
    }
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 flex flex-col px-6 pt-4 pb-8">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-semibold tracking-tight">DopamineOS</h1>
          <p className="text-muted-foreground text-sm mt-1">AI Digital Behavior Prediction</p>
        </div>
